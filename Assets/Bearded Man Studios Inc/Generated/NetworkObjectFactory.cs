			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case Player_NetworkingNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new Player_NetworkingNetworkObject(networker, id, frame);
						break;
					case WorldNetworkingNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new WorldNetworkingNetworkObject(networker, id, frame);
						break;
				}
