...
{
    /// <summary>
    /// Blocktypes hold general shared data about given block. Those are for example texture informations.
    /// </summary>
    [Serializable]
    public readonly struct BlockData
    {
        ...
        public BlockData(bool solid, int2 texture, bool usePhysics = false, float physicsTime = 0f, int cullingMode = 0, bool foliage = false, sbyte marchingCubesLayer = 0, bool liquid = false)
        {
            Solid = solid;
            Texture_Up = texture;
        ...
        public BlockData(bool solid, int2[] textures, bool usePhysics = false, float physicsTime = 0f, int cullingMode = 0, bool foliage = false, sbyte marchingCubesLayer = 0, bool liquid = false)
        {
            Solid = solid;
        ...
        public BlockData(bool solid, List<int2> textures, bool usePhysics = false, float physicsTime = 0f, int cullingMode = 0, bool foliage = false, sbyte marchingCubesLayer = 0, bool liquid = false)
        {
            Solid = solid;
            Texture_Up = textures[(int)BlockTextures.Up];
            Texture_Down = textures[(int)BlockTextures.Down];
        ...
        public BlockData(bool solid = false)
        {
            Solid = solid;
            Texture_Up = new int2();
